...
namespace finalproject {
	...
	/// Summary for facMain
	/// </summary>
	public ref class facMain : public System::Windows::Forms::Form
	{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->facultyToolStripMenuItem });
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &facMain::facMain_FormClosing);
