...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->roleCombo = (gcnew System::Windows::Forms::ComboBox());
			...
			this->label1->Click += gcnew System::EventHandler(this, &newfrmRegister::label1_Click);
			// 
			// label2
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &newfrmRegister::label2_Click);
			// 
			// txtPassword
			// 
			...
			this->txtPassword->TextChanged += gcnew System::EventHandler(this, &newfrmRegister::textBox2_TextChanged);
			// 
			// label3
			// 
			...
			this->label3->Click += gcnew System::EventHandler(this, &newfrmRegister::label3_Click);
			// 
			// btnRegister
			// 
			...
			this->label7->Location = System::Drawing::Point(323, 346);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(108, 32);
			this->label7->TabIndex = 12;
			this->label7->Text = L"Role:";
			this->label7->TextAlign = System::Drawing::ContentAlignment::MiddleLeft;
			// 
			// roleCombo
			// 
			this->roleCombo->FormattingEnabled = true;
			this->roleCombo->Items->AddRange(gcnew cli::array< System::Object^  >(3) { L"Admin", L"Faculty", L"Student" });
			this->roleCombo->Location = System::Drawing::Point(470, 347);
			this->roleCombo->Name = L"roleCombo";
			this->roleCombo->Size = System::Drawing::Size(369, 24);
			this->roleCombo->TabIndex = 13;
			// 
			// newfrmRegister
			// 
			...
			this->Load += gcnew System::EventHandler(this, &newfrmRegister::newfrmRegister_Load);
...
#pragma endregion
	...
	private: System::Void btnRegister_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ roleValue = roleCombo->SelectedItem->ToString();
		int role;
		if (roleValue == "Admin") {
			role = 0;
		}
		...
		if (fname->Length == 0 || lname->Length == 0 || email->Length == 0 || password->Length == 0 || roleValue->Length == 0) {
		...
		try {
			...
			if (sqlCmd->ExecuteNonQuery() == 1) {
				...
				//newfrmLogin^ loginForm = gcnew newfrmLogin();
				//loginForm -> Show();
				this->Close();
			}
			else {
	...
	private: System::Void newfrmRegister_Load(System::Object^ sender, System::EventArgs^ e) {
	}
};
}
