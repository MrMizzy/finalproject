...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2025 at 09:32 PM
...
INSERT INTO `course` (`course_id`, `course_code`, `course_name`, `programme_id`, `level`, `sem`, `credit`) VALUES
(1, 'CS313', 'Intermediate Computer Programming', 1, 300, '', 2.0),
(2, 'CS254', 'OOP', 1, 200, 'summer', 1.0);
...
INSERT INTO `faculty` (`faculty_id`, `department_id`) VALUES
(2, 1);
...
INSERT INTO `programme` (`programme_id`, `prgm_name`, `department_id`, `prgm_type`) VALUES
...
INSERT INTO `student` (`student_id`, `programme_id`, `yearGroup`) VALUES
(3, 1, '2027');
...
INSERT INTO `user` (`uid`, `f_name`, `l_name`, `email`, `password`, `role`) VALUES
(1, 'admin', '', 'admin', 'root', 0),
(2, 'faculty', 'test', 'facultytest', 'root', 1),
(3, 'student', 'test', 'studenttest', 'root', 2);
